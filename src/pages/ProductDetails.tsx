...
export default function ProductDetails() {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
      <Link to="/products" className="inline-flex items-center text-gray-600 hover:text-orange-500 mb-12 transition-colors uppercase tracking-[0.2em] text-[0.6rem] font-bold">
            ...
            <div className="flex flex-col sm:flex-row gap-0 editorial-border p-2 bg-gray-50">
              <div className="flex items-center justify-between px-6 bg-white w-full sm:w-40 h-16 editorial-border border-r-0 border-transparent">
                <button 
                  ...
                  className="text-gray-500 hover:text-orange-500 text-2xl font-light"
                >
                  -
                </button>
              ...
              <button 
                ...
                className="flex-1 bg-gray-900 hover:bg-orange-500 text-gray-50 h-16 font-bold text-xs uppercase tracking-[0.2em] flex items-center justify-center transition-all duration-500 cursor-pointer editorial-border border-l-0 border-transparent"
              >

    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
      ...
      {cartItems.length === 0 ? (
        <div className="bg-white p-16 text-center editorial-border">
          ...
          <Link to="/products" className="inline-flex justify-center px-10 py-5 bg-gray-900 text-gray-50 font-bold uppercase tracking-[0.2em] text-sm hover:bg-orange-500 transition-colors duration-500">
            Commence Selection
          </Link>
        </div>
      ) : (
        <div className="flex flex-col lg:flex-row gap-0 editorial-border bg-white">
          ...
          <div className="flex-grow border-b lg:border-b-0 lg:border-r border-gray-200">
            ...
            <div className="p-8 border-t border-gray-200">
              <Link to="/products" className="inline-flex items-center text-gray-600 hover:text-orange-500 text-xs font-bold uppercase tracking-[0.2em] transition-colors">
          ...
          <div className="w-full lg:w-96 flex-shrink-0 bg-gray-50">
            <div className="p-8 sticky top-24">
              ...
              <Link to="/checkout" className="w-full flex justify-center py-5 px-4 text-xs font-bold uppercase tracking-[0.2em] text-gray-50 bg-gray-900 hover:bg-orange-500 transition-colors duration-500">

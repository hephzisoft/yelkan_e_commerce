  ...
  return (
    <div className="bg-white editorial-border p-8 relative overflow-hidden">
      ...
      <div className="relative z-10">
        ...
        <p className="text-[0.6rem] uppercase tracking-[0.1em] text-gray-600 max-w-sm leading-relaxed mb-8">Distribute identification link. Secure fixed 5.00 dividend per successful connection.</p>
        ...
        <div className="bg-gray-50 p-4 editorial-border flex items-center justify-between">
          ...
          <button 
            ...
            className="bg-gray-900 hover:bg-orange-500 flex-shrink-0 text-gray-50 p-3 editorial-border transition-colors flex items-center justify-center"
          >
